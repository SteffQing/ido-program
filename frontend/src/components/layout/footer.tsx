      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <aside className="grid gap-8 grid-cols-1 sm:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Careers</Link>
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Pricing</Link>
          </div>
        </div>
        <div>
          <h3 className="font-semibold mb-4">Resources</h3>
          <div className="space-y-2">
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Documentation</Link>
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Papers</Link>
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Press Conferences</Link>
          </div>
        </div>
        <div>
          <h3 className="font-semibold mb-4">Legal</h3>
          <div className="space-y-2">
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Terms of Service</Link>
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Privacy Policy</Link>
            <Link href="#" className="block text-gray-400 hover:text-[#00FF88]">Cookies Policy</Link>
